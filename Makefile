...
LANGS=bg bs ca cs cy da de el es fi fr gl hu it ja ko lt nb nl nn pl pt pt_BR ru sk sl sq sv tr uk zh_CN zh_TW
LANGS_DESC=bg bs ca cs cy da de el es fi fr hu it ja ko lt nb nl nn pl pt pt_BR ru sk sl sq sv tr uk zh_CN zh_TW
