...
LANGS=bg bs ca cs cy da de el es fi fr gl hu it ja lt nl nn no pl pt pt_BR ru sk sv uk zh_CN zh_TW
LANGS_DESC=bg bs ca cs cy da de el es fi fr hu ja lt nl no pt pl pt_BR ru sk uk zh_CN
